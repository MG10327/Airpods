...
function BentoSection() {
  return (
    <div id="bento-section" className="w-full lg:h-[70vh] h-[95vh] flex lg:flex-row flex-col  relative border-y border-y-[#424344]" >
      <div className="lg:w-1/2 w-full   h-full flex  items-center justify-center lg:p-32 lg:border-r border-b lg:border-r-[#424344] border-b-[#424344]">
        <video muted autoPlay src={BentoCellVideo} className="bento-cell-video" ></video>
      </div>
