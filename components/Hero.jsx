...
function Hero() {
  ...
  return (
    <div id="hero" className="h-[285vh] w-full flex relative flex-col items-center justify-center" >
      <div className="h-screen hero-sub  fixed top-0 w-full flex flex-col items-center justify-center">
        ...
        <div className="h-screen   fixed top-0 w-full flex flex-col items-center justify-center">
          <video src={DancingVideo} loop autoPlay muted className="h-screen min-w-screen scale-[1.05] z-10 opacity-0 dancing-video object-cover " />
        </div>
        <div className="h-screen   fixed top-0 w-full flex flex-col items-center justify-center">
