 ...
 if (currentScrollPosition >= hero.scrollHeight - window.innerHeight) {
  ...
  let hero_airpords_image = document.getElementById('hero-airpords-image');
      ...
      const scroll_index = Math.floor(
        mapRange( window.scrollY, 0, document.getElementById('hero').clientHeight - window.innerHeight, 1, 32 ) // this is for our scroll ranges between 1 and 32 to tie all 32 frames to a scroll zone that will display the frame images of the airpods.
      );
      ...
      // Here for each of the 32 frames we fade in the images that are in their scroll zone and fade out the images that aren't
